...
public class Fish extends Animal {
	...
	public Fish(JPanel panel, Point point) {
		...
		switch (kind) {
		case 0:
			rightImage = getScaledImage(new ImageIcon("./Q2/1.png").getImage(), size, size);
			leftImage = getScaledImage(new ImageIcon("./Q2/2.png").getImage(), size, size);
			break;
		case 1:
			rightImage = getScaledImage(new ImageIcon("./Q2/3.png").getImage(), size, size);
			leftImage = getScaledImage(new ImageIcon("./Q2/4.png").getImage(), size, size);
			break;
		case 2:
			rightImage = getScaledImage(new ImageIcon("./Q2/5.png").getImage(), size, size);
			leftImage = getScaledImage(new ImageIcon("./Q2/6.png").getImage(), size, size);
			break;
		}
		decide_direction();
