...
public class IOPostSerializable {
	...
	public static PostSerializable readRecords(String filepath)
	   {
		  PostSerializable record=null;
	...
	public static void writeRecords(PostSerializable p,String filepath)
	   {
