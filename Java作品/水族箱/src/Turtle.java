...
public class Turtle extends Animal {
	...
	public Turtle(JPanel panel, Point mousePoint) {
		...
		rightImage = getScaledImage(new ImageIcon("./JAVA_HW6_附件/turtle.png").getImage(), size, size);
		leftImage = getScaledImage(new ImageIcon("./JAVA_HW6_附件/turtle2.png").getImage(), size, size);
